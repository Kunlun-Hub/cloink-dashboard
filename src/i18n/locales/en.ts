const en = {
  ...
  "controlCenter.draft.startBlankLabel": "New Empty Draft",
  "controlCenter.draft.startBlankDescription": "Start from a blank canvas",
  "controlCenter.draft.startCurrentLabel": "From Current View",
  "controlCenter.draft.startCurrentDescription": "Start from the current canvas",
  "controlCenter.addComponents": "Add Components",
  "controlCenter.selectTool": "Select Tool",
  "controlCenter.handTool": "Hand Tool",
  "controlCenter.undo": "Undo",
  "controlCenter.redo": "Redo",
  "controlCenter.fitToView": "Fit to View",
  "controlCenter.autoArrange": "Auto Arrange",
  "controlCenter.emptyResourceTitle": "Create Resources",
  "controlCenter.emptyResourceDescription": "It looks like you don't have any resources. Add internal services like hosts, subnets or domains so your peers can reach them.",
  "controlCenter.addResource": "Add Resource",
  "controlCenter.resourcesLabel": "Resources",
  "controlCenter.addNetwork": "Add Network",
  "controlCenter.networksLabel": "Networks",
  "controlCenter.networkActions": "Network actions",
  "controlCenter.exitFocus": "Exit Focus",
  "controlCenter.feedback": "Feedback",
  "controlCenter.networksAndResources": "Networks & Resources",
  "controlCenter.template.server": "Server",
  "controlCenter.template.serverDescription": "Install on a server or VM",
  "controlCenter.template.agent": "Agent",
  "controlCenter.template.agentDescription": "Add an automated or headless peer",
  "controlCenter.template.group": "Group",
  "controlCenter.template.groupDescription": "Group peers and resources together",
  "controlCenter.template.network": "Network",
  "controlCenter.template.networkDescription": "Give access to a private network",
  "controlCenter.template.resource": "Resource",
  "controlCenter.template.resourceDescription": "A host subnet or domain in a network",
  "controlCenter.template.policy": "Policy",
  "controlCenter.template.policyDescription": "Control access between sources and destinations",
  "controlCenter.panel.addNew": "Add New",
  "controlCenter.panel.existingPeers": "Existing Peers",
  "controlCenter.panel.existingPolicies": "Existing Policies",
  "controlCenter.panel.existingGroups": "Existing Groups",
  "controlCenter.panel.existingNetworks": "Existing Networks",
  "controlCenter.panel.existingResources": "Existing Resources",
  "controlCenter.panel.searchPlaceholder": "Search components, peers, groups, resources...",
  ...
  "passwordReset.action": "Send password reset email",
  "passwordReset.title": "Reset user password",
  "passwordReset.description": "A password reset link will be emailed to {email}. The link is valid for 30 minutes and can only be used once.",
  "passwordReset.send": "Send reset link",
  "passwordReset.sending": "Sending reset link...",
  "passwordReset.sendingTitle": "Password reset link",
  "passwordReset.sendingDescription": "Creating a reset link for {email}",
  "passwordReset.createdTitle": "Password reset link created",
  "passwordReset.createdDescription": "Share this link with {email} if they cannot receive the email. The link is valid for 30 minutes and can only be used once.",
  "passwordReset.emailSent": "The reset email has been sent.",
  "passwordReset.emailFailed": "The reset email could not be sent. Share the link below instead.",
  "passwordReset.linkCopied": "Reset link copied to clipboard.",
  "passwordReset.expiresOn": "Expires on",
  "passwordReset.close": "Close",
  "emailSettings.templatePasswordReset": "Password reset",
  "emailSettings.defaultPasswordResetSubject": "Reset your Cloink password",
  "emailSettings.defaultPasswordResetHtml": "<p>We received a request to reset your Cloink password.</p>\n<p>Account: {{.user.email}}</p>\n<p><a href=\"{{.reset.url}}\">Set a new password</a></p>\n<p>The link expires at {{.reset.expires_at}}. If you did not request this, you can ignore this email and your password will stay unchanged.</p>",
  "emailSettings.defaultPasswordResetText": "We received a request to reset your Cloink password.\n\nAccount: {{.user.email}}\nSet a new password: {{.reset.url}}\n\nThe link expires at {{.reset.expires_at}}. If you did not request this, you can ignore this email and your password will stay unchanged.",
  ...
  "activity.wasRevoked": "was revoked",
  "activity.wasDeleted": "was deleted",
  "activity.wasCreated": "was created",
  "activity.wasRemovedFromThe": "was removed from the",
  "activity.wasAddedToThe": "was added to the",
  "activity.wasUpdated": "was updated",
  "activity.joinedNetBird": "joined NetBird",
  "activity.wasInvited": "was invited.",
  "activity.wasCreatedBy": "was created by",
  "activity.wasAddedToUser": "was added to user",
  "activity.wasRemovedFromUser": "was removed from user",
  "activity.wasUpdatedOfUser": "was updated of user",
  "activity.wasRemovedFromPeerWithIp": "was removed from the peer with the NetBird IP",
  "activity.wasAddedToPeerWithIp": "was added to the peer with the NetBird IP",
  "activity.expired": "expired",
  "activity.sshServerOfPeer": "SSH Server of peer",
  "activity.peerWithNetBirdIp": "Peer with the NetBird IP",
  "activity.wasRenamedTo": "was renamed to",
  "activity.ipAddressUpdatedFrom": "IP address was updated from",
  "activity.accountNetworkRangeUpdatedFrom": "Account network range was updated from",
  "activity.integrationCreated": "integration created",
  "activity.integrationDeleted": "integration deleted",
  "activity.integrationUpdated": "integration updated",
  "activity.wasAddedToDisabledDnsGroup": "was added to disabled DNS group setting",
  "activity.wasRemovedFromDisabledDnsGroup": "was removed from disabled DNS group setting",
  "activity.withTheNetBirdIp": "with the NetBird IP",
  "activity.exposedService": "exposed service",
  "activity.unexposedService": "unexposed service",
  "activity.createdForNetwork": "created for network",
  "activity.updatedForNetwork": "updated for network",
  "activity.deletedFromNetwork": "deleted from network",
  "activity.routingPeerCreatedForNetwork": "Routing peer created for network",
  "activity.routingPeerDeletedFromNetwork": "Routing peer deleted from network",
  "activity.routingPeerUpdatedFromNetwork": "Routing peer updated from network",
  "activity.networkWithName": "Network with name",
  "activity.createdForPeer": "created for peer",
  "activity.wasCreatedWithAuth": "was created with authentication",
  "activity.wasUpdatedWithAuth": "was updated with authentication",
  "activity.from": "from",
  ...
  "networks.nameLabel": "Network Name",
  "networks.nameHelp": "Provide a unique name for the network.",
  "networks.namePlaceholder": "e.g., Office Network",
  "networks.descriptionHelp": "Write a short description to add more context to this network.",
  "networks.descriptionPlaceholder": "e.g., Berlin, Münzstraße 12",
  "networks.resourceNameHelp": "Set an easily identifiable name for your resource",
  "networks.resourceNamePlaceholder": "e.g., Postgres Database",
  "networks.enterSingle": "Enter a single",
  "networks.singleHostTooltip": "A single host address, e.g., 10.0.0.1 or 192.168.1.5. Use this to give access to a specific machine or service.",
  "networks.cidrTooltip": "To give access to an entire subnet, use a CIDR block. For example, 10.0.0.0/24 or 192.168.1.0/24.",
  "networks.domainTooltip": "A DNS domain name, e.g., service.internal, example.com or *.example.com to match all subdomains.",
  "networks.resourceDescriptionHelp": "Write a short description to add more context to this resource.",
  "networks.resourceDescriptionPlaceholder": "e.g., Production, Development",
  "networks.resourceGroupsLabel": "Resource Groups",
  "networks.resourceGroupsHelp": "Add this resource to a group (e.g., Databases, Web Servers) and reference the group in access policies to simplify management.",
  "networks.resourceGroupsPlaceholder": "Add or select resource group(s)...",
  "networks.resourceGroupsUsedIn": "Your selected resource groups are used in",
  "networks.resourceInheritsAccess": ". This resource will inherit access from {scope}.",
  "networks.thisPolicy": "this policy",
  "networks.thesePolicies": "these policies",
  "networks.pleaseReviewIn": "Please review them in the",
  "networks.tabSuffix": "tab.",
  "networks.pleaseReviewInAccessControl": "Please review them in the Access Control tab.",
  "networks.reviewOnCanvas": "Review them on the canvas before you deploy.",
  "networks.peerGroup": "Peer Group",
  "networks.routingPeersHelp": "Assign a single or multiple peers as routing peers for the network.",
  "networks.routingPeerGroupHelp": "Assign a peer group with machines to be used as routing peers.",
  "networks.noRoutingPeerTitle": "Don't have a routing peer?",
  "networks.noRoutingPeerHelp": "You can install Cloink with a setup key on one or more machines to act as routing peers.",
  "networks.enableRoutingPeer": "Enable Routing Peer",
  "networks.enableRoutingPeerHelp": "Use this switch to enable or disable the routing peer.",
  "networks.metricLabel": "Metric",
  "networks.metricHelp": "A lower metric indicates higher priority routing peers.",
  "networks.addRoutingPeer": "Add Routing Peer",
  ...
  "setupModal.generateKey": "Generate Key",
  "setupModal.setupKeyExpiryNotice": "This setup key can be used only once and expires in 24 hours.",
  ...
  "common.never": "Never",
  "controlCenter.mode.live": "Live",
  "controlCenter.mode.draft": "Draft",
  "controlCenter.gotIt": "Got it",
  "controlCenter.noNetwork": "No Network",
  "controlCenter.draft.reviewAndDeploy": "Review & Deploy",
  "controlCenter.draft.noPendingChanges": "No pending changes.",
  "controlCenter.draft.approveAndDeploy": "Approve & Deploy",
  "controlCenter.draft.resolveIssuesFirst": "Resolve issues before deploying",
  "controlCenter.draft.copyUrl": "Copy URL",
  "controlCenter.draft.copyCurl": "Copy cURL",
  "controlCenter.draft.deploying": "Deploying",
  "controlCenter.draft.deployed": "Deployed",
  "controlCenter.draft.userDeviceDescription": "Install Cloink and assign the registered peer.",
  "controlCenter.draft.installCloinkStep": "Install Cloink on the device. Skip if it is already installed.",
  "controlCenter.draft.assignPeerDescription": "Assign the peer this device registered as",
  "controlCenter.draft.searchPeers": "Search peers...",
  "controlCenter.draft.selectPeer": "Select a peer...",
  "controlCenter.draft.assign": "Assign",
  "controlCenter.draft.assignNetworkTitle": "Assign a network",
  "controlCenter.draft.assignNetworkDescription": "Pick a network for this resource or create a new one.",
  "controlCenter.draft.searchNetworks": "Search networks...",
  "controlCenter.draft.selectOrCreateNetwork": "Select or create a network...",
  "controlCenter.draft.assignNetwork": "Assign Network",
  "controlCenter.draft.selectDestinationTitle": "Select Destination",
  "controlCenter.draft.selectDestinationPlaceholder": "Select destination(s)...",
  "controlCenter.draft.connect": "Connect",
  "controlCenter.draft.createGroup": "Create Group",
  "controlCenter.draft.groupNameDescription": "Set an easily identifiable name for your group.",
  "controlCenter.draft.groupNamePlaceholder": "e.g., Developers",
  "controlCenter.draft.reservedGroupName": "The name \"All\" is reserved. Please choose another name.",
  "controlCenter.draft.groupExists": "This group already exists. Please choose another name.",
  "controlCenter.draft.renameGroup": "Rename Group",
  "controlCenter.draft.rename": "Rename",
  "controlCenter.draft.peerInstalledTitle": "Peer installed",
  "controlCenter.draft.routingPeerNotInstalledTitle": "Routing peer not installed yet",
  "controlCenter.draft.routingPeerNotInstalledDescription": "This routing peer uses a peer that hasn't been installed. Install it to edit these settings, or remove this change and add the routing peer again.",
  "controlCenter.draft.resourceDestinationConflict": "This policy already has a resource destination. Remove it from the policy first.",
  "controlCenter.draft.groupDestinationConflict": "This policy already has group destinations, and a resource can't be combined with them. Pick groups instead.",
  "common.moreActions": "More actions",
  "controlCenter.draft.networkHasNoResources": "This network has no resources yet.",
  ...
  "trafficEvents.filterInboundLabel": "Inbound",
  "trafficEvents.filterOutboundLabel": "Outbound",
  "trafficEvents.domain": "Domain",
  "trafficEvents.domainCopiedToClipboard": "Domain has been copied to your clipboard",
  "trafficEvents.userEmail": "User E-Mail",
  "trafficEvents.emailCopiedToClipboard": "E-Mail has been copied to your clipboard",
  "trafficEvents.region": "Region",
  "trafficEvents.regionCopiedToClipboard": "Region has been copied to your clipboard",
  "trafficEvents.peerTabDescription": "Here you can see all the {direction} traffic events for this peer.",
  "trafficEvents.goToSettings": "Go to Settings",
  "trafficEvents.policyBlockedConnection": "blocked the connection",
  "trafficEvents.policyAllowedConnection": "allowed the connection",
  "table.filters": "Filters",
  "domains.countLabel": "{count} Domains",
  "domains.examplePlaceholder": "e.g., example.com",
  "accessControl.routeCount": "{count} Route(s)",
  ...
  "trafficEvents.noUserBound": "No user bound to this device",
  ...
  "counts.peer": "{count} Peer",
  "counts.peers": "{count} Peers",
  "counts.resource": "{count} Resource",
  "counts.resources": "{count} Resources",
  "counts.routingPeer": "{count} Routing Peer",
  "counts.routingPeers": "{count} Routing Peers",
  "counts.service": "{count} Service",
  "counts.services": "{count} Services",
  "counts.activePolicy": "{count} Active Policy",
  "counts.activePolicies": "{count} Active Policies",
  "counts.noResources": "No Resources",
  "counts.noPeersOrResources": "No Peers",
  "counts.key": "{count} Key",
  "counts.keys": "{count} Keys",
  "counts.server": "{count} Server",
  "counts.servers": "{count} Servers",
  "dns.nameserverActions": "Nameserver actions",
  "dns.zoneActions": "Zone actions",
  "groups.selectAllOnPage": "Select all groups on this page",
  "common.you": "You",
  "peerGroupSelector.noGroupsMatchingSearch":
    "There are no groups matching your search. Please try a different search term.",
  "peerGroupSelector.noGroupsWithResources":
    "There are no groups that contain resources yet.",
  "controlCenter.noGroupsMatching":
    "There are no groups matching your search. Please try a different search term.",
  "controlCenter.noGroupsYet": "There are no groups yet.",
  "controlCenter.noPeersInGroup": "There are no peers in this group yet.",
  "controlCenter.noResourcesInGroup": "There are no resources in this group yet.",
  "common.assign": "Assign",
  "common.install": "Install",
  "controlCenter.installOrAssign": "Install or assign",
  "controlCenter.waitingForRegistration": "Waiting",
  "controlCenter.selectNodeToFocus": "Select a node to focus",
  "controlCenter.focusingOn": "Focusing on “{name}”",
  "controlCenter.nodeFallback": "node",
