const zhCN = {
  ...
  "controlCenter.draft.startBlankLabel": "新建空白草稿",
  "controlCenter.draft.startBlankDescription": "从空白画布开始",
  "controlCenter.draft.startCurrentLabel": "基于当前视图",
  "controlCenter.draft.startCurrentDescription": "从当前画布开始",
  "controlCenter.addComponents": "添加组件",
  "controlCenter.selectTool": "选择工具",
  "controlCenter.handTool": "抓手工具",
  "controlCenter.undo": "撤销",
  "controlCenter.redo": "重做",
  "controlCenter.fitToView": "适应视图",
  "controlCenter.autoArrange": "自动排列",
  "controlCenter.emptyResourceTitle": "创建资源",
  "controlCenter.emptyResourceDescription": "看起来你还没有任何资源。添加主机、子网或域名等内部服务，让设备可以访问它们。",
  "controlCenter.addResource": "添加资源",
  "controlCenter.resourcesLabel": "资源",
  "controlCenter.addNetwork": "添加网络",
  "controlCenter.networksLabel": "网络",
  "controlCenter.networkActions": "网络操作",
  "controlCenter.exitFocus": "退出聚焦",
  "controlCenter.feedback": "反馈",
  "controlCenter.networksAndResources": "网络与资源",
  "controlCenter.template.server": "服务器",
  "controlCenter.template.serverDescription": "安装在服务器或虚拟机上",
  "controlCenter.template.agent": "代理",
  "controlCenter.template.agentDescription": "添加自动化或无界面设备",
  "controlCenter.template.group": "分组",
  "controlCenter.template.groupDescription": "将设备和资源归为一组",
  "controlCenter.template.network": "网络",
  "controlCenter.template.networkDescription": "开放对私有网络的访问",
  "controlCenter.template.resource": "资源",
  "controlCenter.template.resourceDescription": "网络中的主机、子网或域名",
  "controlCenter.template.policy": "策略",
  "controlCenter.template.policyDescription": "控制来源与目标之间的访问",
  "controlCenter.panel.addNew": "新增",
  "controlCenter.panel.existingPeers": "已有设备",
  "controlCenter.panel.existingPolicies": "已有策略",
  "controlCenter.panel.existingGroups": "已有分组",
  "controlCenter.panel.existingNetworks": "已有网络",
  "controlCenter.panel.existingResources": "已有资源",
  "controlCenter.panel.searchPlaceholder": "搜索组件、设备、分组、资源...",
  ...
  "versionReleases.modalDescription": "配置安装包元数据，发布签名由服务端自动生成。",
  ...
  "passwordReset.action": "发送重置密码邮件",
  "passwordReset.title": "重置用户密码",
  "passwordReset.description": "重置密码链接将发送至 {email}。链接 30 分钟内有效，且只能使用一次。",
  "passwordReset.send": "发送重置链接",
  "passwordReset.sending": "正在发送重置链接...",
  "passwordReset.sendingTitle": "重置密码链接",
  "passwordReset.sendingDescription": "正在为 {email} 生成重置链接",
  "passwordReset.createdTitle": "重置密码链接已生成",
  "passwordReset.createdDescription": "如果 {email} 收不到邮件，可以把下面的链接直接发给对方。链接 30 分钟内有效，且只能使用一次。",
  "passwordReset.emailSent": "重置密码邮件已发送。",
  "passwordReset.emailFailed": "重置密码邮件发送失败，请把下面的链接直接发给对方。",
  "passwordReset.linkCopied": "重置链接已复制到剪贴板。",
  "passwordReset.expiresOn": "过期时间",
  "passwordReset.close": "关闭",
  "emailSettings.templatePasswordReset": "重置密码",
  "emailSettings.defaultPasswordResetSubject": "重置你的 Cloink 密码",
  "emailSettings.defaultPasswordResetHtml": "<p>我们收到了重置你的 Cloink 账号密码的请求。</p>\n<p>账号：{{.user.email}}</p>\n<p><a href=\"{{.reset.url}}\">设置新密码</a></p>\n<p>链接将在 {{.reset.expires_at}} 过期。如果这不是你本人的操作，请忽略这封邮件，你的密码不会发生变化。</p>",
  "emailSettings.defaultPasswordResetText": "我们收到了重置你的 Cloink 账号密码的请求。\n\n账号：{{.user.email}}\n设置新密码：{{.reset.url}}\n\n链接将在 {{.reset.expires_at}} 过期。如果这不是你本人的操作，请忽略这封邮件，你的密码不会发生变化。",
  ...
  "userRoles.agentNetworkAdmin": "代理网络管理员",
  "userRoles.usageViewer": "用量查看员",
  "userRoles.categoryGeneral": "常规",
  "userRoles.desc.owner": "完全访问权限，包括转移所有权。",
  "userRoles.desc.admin": "管理用户、节点、网络和账户设置。",
  "userRoles.desc.networkAdmin": "管理节点、网络和访问控制。",
  "userRoles.desc.billingAdmin": "管理订阅和账单详情。",
  "userRoles.desc.auditor": "对配置和审计事件的只读访问。",
  "userRoles.desc.user": "仅能访问自己的节点。",
  "userRoles.desc.agentNetworkAdmin": "管理 AI 提供商、代理策略和防护规则。",
  "userRoles.desc.usageViewer": "对用量和日志的只读访问。",
  ...
  "activity.wasRevoked": "已被撤销",
  "activity.wasDeleted": "已被删除",
  "activity.wasCreated": "已创建",
  "activity.wasRemovedFromThe": "已从以下项移除：",
  "activity.wasAddedToThe": "已添加到",
  "activity.wasUpdated": "已更新",
  "activity.joinedNetBird": "加入了 Cloink",
  "activity.wasInvited": "已被邀请。",
  "activity.wasCreatedBy": "由以下用户创建：",
  "activity.wasAddedToUser": "已添加到用户",
  "activity.wasRemovedFromUser": "已从用户移除：",
  "activity.wasUpdatedOfUser": "已更新，属于用户",
  "activity.wasRemovedFromPeerWithIp": "已从该设备移除，NetBird IP 为",
  "activity.wasAddedToPeerWithIp": "已添加到该设备，NetBird IP 为",
  "activity.expired": "已过期",
  "activity.sshServerOfPeer": "设备的 SSH 服务",
  "activity.peerWithNetBirdIp": "NetBird IP 为",
  "activity.wasRenamedTo": "已重命名为",
  "activity.ipAddressUpdatedFrom": "IP 地址已更新，原为",
  "activity.accountNetworkRangeUpdatedFrom": "账户网络范围已更新，原为",
  "activity.integrationCreated": "集成已创建",
  "activity.integrationDeleted": "集成已删除",
  "activity.integrationUpdated": "集成已更新",
  "activity.wasAddedToDisabledDnsGroup": "已添加到已禁用的 DNS 分组设置",
  "activity.wasRemovedFromDisabledDnsGroup": "已从已禁用的 DNS 分组设置移除",
  "activity.withTheNetBirdIp": "，NetBird IP 为",
  "activity.exposedService": "公开了服务",
  "activity.unexposedService": "取消了服务公开",
  "activity.createdForNetwork": "已为网络创建",
  "activity.updatedForNetwork": "已为网络更新",
  "activity.deletedFromNetwork": "已从网络删除",
  "activity.routingPeerCreatedForNetwork": "已为网络创建路由设备",
  "activity.routingPeerDeletedFromNetwork": "已从网络删除路由设备",
  "activity.routingPeerUpdatedFromNetwork": "已更新网络的路由设备",
  "activity.networkWithName": "名称为",
  "activity.createdForPeer": "已为设备创建",
  "activity.wasCreatedWithAuth": "已创建并启用认证",
  "activity.wasUpdatedWithAuth": "已更新并启用认证",
  "activity.from": "来自",
  ...
  "activity.userPasswordReset": "用户通过找回链接重置了密码",
  ...
  "peerSsh.cliStepCommandsElevated": "在提升权限的命令行中执行这些命令",
  "peerSsh.cliStepCommandsRoot": "以 root 身份执行这些命令",
  "peerSsh.cliStepIntroSuffix":
    "。仅在 Cloink 已在运行时才需要执行第一条。如果你没有相应权限，需要由管理员执行。",
  ...
  "userDetails.ownerRoleChangeRestricted": "只有账户所有者可以更改所有者的角色。",
  ...
  "networks.nameLabel": "网络名称",
  "networks.nameHelp": "为网络提供一个唯一的名称。",
  "networks.namePlaceholder": "例如：办公室网络",
  "networks.descriptionHelp": "写一段简短描述，为这个网络补充更多背景信息。",
  "networks.descriptionPlaceholder": "例如：柏林，Münzstraße 12",
  "networks.resourceNameHelp": "为你的资源设置一个易于识别的名称",
  "networks.resourceNamePlaceholder": "例如：Postgres 数据库",
  "networks.enterSingle": "输入一个",
  "networks.singleHostTooltip": "单个主机地址，例如 10.0.0.1 或 192.168.1.5。用于开放对某台机器或服务的访问。",
  "networks.cidrTooltip": "如需开放整个子网，请使用 CIDR 网段，例如 10.0.0.0/24 或 192.168.1.0/24。",
  "networks.domainTooltip": "DNS 域名，例如 service.internal、example.com，或使用 *.example.com 匹配所有子域名。",
  "networks.resourceDescriptionHelp": "写一段简短描述，为这个资源补充更多背景信息。",
  "networks.resourceDescriptionPlaceholder": "例如：生产环境、开发环境",
  "networks.resourceGroupsLabel": "资源分组",
  "networks.resourceGroupsHelp": "将该资源加入分组（例如：数据库、Web 服务器），并在访问策略中引用该分组，以简化管理。",
  "networks.resourceGroupsPlaceholder": "添加或选择资源分组...",
  "networks.resourceGroupsUsedIn": "你选择的资源分组被用于",
  "networks.resourceInheritsAccess": "。该资源将继承{scope}的访问权限。",
  "networks.thisPolicy": "此策略",
  "networks.thesePolicies": "这些策略",
  "networks.pleaseReviewIn": "请在",
  "networks.tabSuffix": "标签页中检查它们。",
  "networks.pleaseReviewInAccessControl": "请在“访问控制”标签页中检查它们。",
  "networks.reviewOnCanvas": "部署前请先在画布上检查它们。",
  "networks.peerGroup": "设备分组",
  "networks.routingPeersHelp": "为该网络指定一个或多个设备作为路由设备。",
  "networks.routingPeerGroupHelp": "指定一个包含机器的设备分组作为路由设备。",
  "networks.noRoutingPeerTitle": "还没有路由设备？",
  "networks.noRoutingPeerHelp": "你可以使用设置密钥在一台或多台机器上安装 Cloink，让它们充当路由设备。",
  "networks.enableRoutingPeer": "启用路由设备",
  "networks.enableRoutingPeerHelp": "使用此开关启用或禁用该路由设备。",
  "networks.metricLabel": "优先级值",
  "networks.metricHelp": "数值越小，路由设备的优先级越高。",
  "networks.addRoutingPeer": "添加路由设备",
  ...
  "setupModal.generateKey": "生成密钥",
  "setupModal.setupKeyExpiryNotice": "该设置密钥只能使用一次，并在 24 小时后过期。",
  ...
  "aiProvider.notify.providerNotUpdated.title": "提供商未更新",
  "aiProvider.notify.providerNotUpdated.description": "此提供商已不再可用，请刷新页面。",
  ...
  "common.never": "从未",
  "controlCenter.mode.live": "实时",
  "controlCenter.mode.draft": "草稿",
  "controlCenter.gotIt": "知道了",
  "controlCenter.noNetwork": "未分配网络",
  "controlCenter.draft.reviewAndDeploy": "审核并部署",
  "controlCenter.draft.noPendingChanges": "没有待处理的变更。",
  "controlCenter.draft.approveAndDeploy": "批准并部署",
  "controlCenter.draft.resolveIssuesFirst": "请先解决以下问题再部署",
  "controlCenter.draft.copyUrl": "复制链接",
  "controlCenter.draft.copyCurl": "复制 cURL",
  "controlCenter.draft.deploying": "部署中",
  "controlCenter.draft.deployed": "已部署",
  "controlCenter.draft.userDeviceDescription": "安装 Cloink 并分配已注册的设备。",
  "controlCenter.draft.installCloinkStep": "在设备上安装 Cloink。如果已安装可跳过。",
  "controlCenter.draft.assignPeerDescription": "分配该设备注册后对应的设备",
  "controlCenter.draft.searchPeers": "搜索设备...",
  "controlCenter.draft.selectPeer": "选择设备...",
  "controlCenter.draft.assign": "分配",
  "controlCenter.draft.assignNetworkTitle": "分配网络",
  "controlCenter.draft.assignNetworkDescription": "为该资源选择一个网络，或新建一个网络。",
  "controlCenter.draft.searchNetworks": "搜索网络...",
  "controlCenter.draft.selectOrCreateNetwork": "选择或新建网络...",
  "controlCenter.draft.assignNetwork": "分配网络",
  "controlCenter.draft.selectDestinationTitle": "选择目标",
  "controlCenter.draft.selectDestinationPlaceholder": "选择目标...",
  "controlCenter.draft.connect": "连接",
  "controlCenter.draft.createGroup": "创建分组",
  "controlCenter.draft.groupNameDescription": "为你的分组设置一个易于识别的名称。",
  "controlCenter.draft.groupNamePlaceholder": "例如：开发团队",
  "controlCenter.draft.reservedGroupName": "名称 \"All\" 为系统保留，请换一个名称。",
  "controlCenter.draft.groupExists": "该分组已存在，请换一个名称。",
  "controlCenter.draft.renameGroup": "重命名分组",
  "controlCenter.draft.rename": "重命名",
  "controlCenter.draft.peerInstalledTitle": "设备已安装",
  "controlCenter.draft.routingPeerNotInstalledTitle": "路由设备尚未安装",
  "controlCenter.draft.routingPeerNotInstalledDescription": "该路由设备使用了一个尚未安装的设备。请先安装它再编辑这些设置，或移除此变更后重新添加路由设备。",
  "controlCenter.draft.resourceDestinationConflict": "该策略已有一个资源目标，请先从策略中移除它。",
  "controlCenter.draft.groupDestinationConflict": "该策略已有分组目标，资源不能与分组同时使用，请改为选择分组。",
  "common.moreActions": "更多操作",
  "controlCenter.draft.networkHasNoResources": "该网络还没有任何资源。",
  ...
  "trafficEvents.filterInboundLabel": "入站",
  "trafficEvents.filterOutboundLabel": "出站",
  "trafficEvents.domain": "域名",
  "trafficEvents.domainCopiedToClipboard": "域名已复制到剪贴板",
  "trafficEvents.userEmail": "用户邮箱",
  "trafficEvents.emailCopiedToClipboard": "邮箱已复制到剪贴板",
  "trafficEvents.region": "地区",
  "trafficEvents.regionCopiedToClipboard": "地区已复制到剪贴板",
  "trafficEvents.peerTabDescription": "这里显示该设备的全部{direction}流量事件。",
  "trafficEvents.goToSettings": "前往设置",
  "trafficEvents.policyBlockedConnection": "阻止了该连接",
  "trafficEvents.policyAllowedConnection": "允许了该连接",
  "table.filters": "筛选",
  "domains.countLabel": "{count} 个域名",
  "domains.examplePlaceholder": "例如：example.com",
  "accessControl.routeCount": "{count} 条路由",
  "common.togglePasswordVisibility": "显示或隐藏密码",
  ...
  "pendingApproval.accountCreated": "账号已创建",
  "pendingApproval.waitingForApproval": "等待审批",
  "pendingApproval.joinAccount": "加入账号",
  "pendingApproval.description": "你的组织要求新用户加入前必须经过人工审批。",
  "pendingApproval.askOwnerWithEmail": "请联系账号所有者",
  "pendingApproval.askOwnerSuffix": "以批准你的访问。",
  "pendingApproval.askOwner": "请联系账号所有者批准你的访问。",
  "pendingApproval.refresh": "刷新",
  "pendingApproval.logOut": "退出登录",
  "pendingApproval.needHelp": "需要帮助？",
  "pendingApproval.readTheDocs": "阅读文档",
  "pendingApproval.contactSupport": "联系支持",
  "groupsMultiSelect.selectedSingle": "已选择分组",
  "groupsMultiSelect.selectedPlural": "已选择多个分组",
  "groupsMultiSelect.deleteAll": "全部删除",
  "groupsMultiSelect.deleteAllTooltip": "删除所选分组",
  "groupsMultiSelect.deleteTitleSingle": "删除 {count} 个分组？",
  "groupsMultiSelect.deleteTitlePlural": "删除 {count} 个分组？",
  "groupsMultiSelect.deleteDescriptionSingle": "确定要删除该分组吗？此操作无法撤销。",
  "groupsMultiSelect.deleteDescriptionPlural": "确定要删除这些分组吗？此操作无法撤销。",
  "groupsMultiSelect.deleteNotifyTitle": "删除分组",
  "groupsMultiSelect.deleteNotifySingle": "分组已成功删除",
  "groupsMultiSelect.deleteNotifyPlural": "分组已成功删除",
  "groupsMultiSelect.deletingSingle": "正在删除所选分组...",
  "groupsMultiSelect.deletingPlural": "正在删除所选分组...",
  "groupsMultiSelect.partialFailure": "{total} 个分组中有 {failed} 个无法删除。",
  "invoices.emptyTitle": "暂无发票",
  "invoices.emptyDescription": "发票会在每个计费周期结束时生成，生成后即可在此查看。",
  "webhooks.customAuthLabel": "HTTP 请求头名称与值",
  "webhooks.customAuthHelp": "为自定义认证指定请求头名称和值",
  "authenticationTab.peerApproval": "设备审批",
  "authenticationTab.peerApprovalDisabledByIntegration":
    "由于已启用 {integration} 集成，设备审批已被禁用。如需启用设备审批，请先禁用 {integration} 集成。",
  "invoices.typeAccount": "账号",
  "invoices.typeCustomers": "客户",
  "invoices.typeTenants": "租户",
  "entraSCIM.notLoggedInPrefix": "当前账号似乎未通过 Entra ID 登录。请退出登录，然后在登录页面使用",
  "entraSCIM.notLoggedInSuffix": "按钮重新登录。",
  "emailSettings.fromNamePlaceholder": "Cloink",
  "counts.peer": "{count} 个节点",
  "counts.peers": "{count} 个节点",
  "counts.resource": "{count} 个资源",
  "counts.resources": "{count} 个资源",
  "counts.routingPeer": "{count} 个路由节点",
  "counts.routingPeers": "{count} 个路由节点",
  "counts.service": "{count} 个服务",
  "counts.services": "{count} 个服务",
  "counts.activePolicy": "{count} 条启用中的策略",
  "counts.activePolicies": "{count} 条启用中的策略",
  "counts.noResources": "暂无资源",
  "counts.noPeersOrResources": "无节点或资源",
  "counts.key": "{count} 个密钥",
  "counts.keys": "{count} 个密钥",
  "counts.server": "{count} 个服务器",
  "counts.servers": "{count} 个服务器",
  "dns.nameserverActions": "域名服务器操作",
  "dns.zoneActions": "区域操作",
  "groups.selectAllOnPage": "选中本页所有分组",
  "common.you": "我",
  "peerGroupSelector.noGroupsMatchingSearch": "没有找到匹配的分组。请尝试不同的搜索条件。",
  "peerGroupSelector.noGroupsWithResources": "暂无可用于资源的分组。",
  "controlCenter.noGroupsMatching": "没有找到匹配的分组。请尝试不同的搜索条件。",
  "controlCenter.noGroupsYet": "暂无分组。",
  "controlCenter.noPeersInGroup": "该分组中暂无节点。",
  "controlCenter.noResourcesInGroup": "该分组中暂无资源。",
  "common.assign": "分配",
  "common.install": "安装",
  "controlCenter.installOrAssign": "安装或分配",
  "controlCenter.waitingForRegistration": "等待注册",
  "controlCenter.selectNodeToFocus": "选择一个节点以聚焦",
  "controlCenter.focusingOn": "正在聚焦“{name}”",
  "controlCenter.nodeFallback": "节点",
