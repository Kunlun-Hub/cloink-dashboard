...
export const UserRoleCategories: {
  ...
  { value: "general", nameKey: "userRoles.categoryGeneral", icon: UsersIcon },
  {
    value: "agent-network",
    nameKey: "nav.agentNetwork",
...
export const UserRoles: {
...
}[] = [
  {
    ...
    icon: NetBirdIcon,
    category: "general",
    descriptionKey: "userRoles.desc.owner",
  },
  {
    ...
    icon: Cog,
    category: "general",
    descriptionKey: "userRoles.desc.admin",
  },
  {
    ...
    icon: NetworkIcon,
    category: "general",
    descriptionKey: "userRoles.desc.networkAdmin",
  },
  {
    ...
    icon: CreditCard,
    category: "general",
    descriptionKey: "userRoles.desc.billingAdmin",
  },
  {
    ...
    icon: EyeIcon,
    category: "general",
    descriptionKey: "userRoles.desc.auditor",
  },
  {
    ...
    icon: User2,
    category: "general",
    descriptionKey: "userRoles.desc.user",
  },
  {
    nameKey: "userRoles.agentNetworkAdmin",
    shortNameKey: "userRoles.admin",
    value: Role.AgentNetworkAdmin,
    icon: AgentNetworkIcon,
    category: "agent-network",
    descriptionKey: "userRoles.desc.agentNetworkAdmin",
  },
  {
    nameKey: "userRoles.usageViewer",
    value: Role.UsageViewer,
    icon: GaugeIcon,
    category: "agent-network",
    descriptionKey: "userRoles.desc.usageViewer",
  },
];
              ...
              <div className={"flex items-start gap-2.5 p-1"}>
                ...
                <div className={"flex flex-col text-sm font-medium"}>
                  <span className={"text-nb-gray-200 whitespace-nowrap"}>
                    {useShortNames
                      ? t(item.shortNameKey ?? item.nameKey)
                      : t(item.nameKey)}
                  </span>
