    ...
    <DropdownMenu modal={false}>
      <DropdownMenuTrigger asChild>
        <button
          ...
          className={
            "flex items-center justify-center h-[40px] px-4 shrink-0 rounded-r-md border border-l-0 border-gray-700/40 bg-nb-gray-920 text-nb-gray-400 hover:text-nb-gray-100 hover:bg-nb-gray-910 transition-colors"
          }
        >
  ...
  return (
    <button
      ...
      className={cn(
        ...
        "bg-nb-gray-920 border border-gray-700/40 text-nb-gray-400",
        "hover:text-nb-gray-100 hover:bg-nb-gray-910 transition-colors",
      )}
    >
