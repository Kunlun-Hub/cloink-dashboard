  ...
  return (
    <div className={"relative flex flex-col h-full justify-between"}>
      <div>
        ...
        >
          {t("onboarding.endDescriptionExtended")}
        </div>
        ...
        <div className={"mt-8 flex flex-col gap-8"}>
          ...
          <VideoGuide
            ...
            description={t("onboarding.videoHowDescriptionExtended")}
            src={ActivityImage}
...
const VideoGuide = ({
  ...
  const { t } = useI18n();
  const titleText = title ?? t("onboarding.videoAclTitle");
  ...
  return (
    ...
    >
      ...
      <div>
        <div className={"text-md"}>{titleText}</div>
        <div
