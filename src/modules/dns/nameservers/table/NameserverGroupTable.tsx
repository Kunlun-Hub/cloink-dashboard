...
export const NameserverGroupTableColumns = (t: (...args: any[]) => string): ColumnDef<NameserverGroup>[] => [
  {
    accessorKey: "name",
    header: ({ column }) => {
      return <DataTableHeader column={column}>{t("nameservers.name")}</DataTableHeader>;
    },
    sortingFn: "text",
  ...
  },
  {
    ...
    id: "groups",
    header: ({ column }) => {
      return <DataTableHeader column={column}>{t("groups.groups")}</DataTableHeader>;
    },
...
export default function NameserverGroupTable({
  ...
  const statusOptions = useMemo<RadioOption<boolean | undefined>[]>(
    () => [
      { value: undefined, label: t("nameservers.all"), dotClass: "bg-nb-gray-500" },
      { value: true, label: t("nameservers.active"), dotClass: "bg-green-500" },
      { value: false, label: t("nameservers.inactive"), dotClass: "bg-nb-gray-700" },
    ],
    [],
  );
