          ...
          <div className={"flex items-center flex-col"}>
            ...
            {postureChecks.length > 0 && (
              <button
                ...
                className={
                  "text-center mt-4 text-xs text-red-700 dark:text-red-500 flex items-center leading-none hover:bg-red-900/40 py-2 px-3 rounded-full transition-all border border-transparent hover:border-red-500"
                }
              >
