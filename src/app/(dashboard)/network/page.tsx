          ...
          >
            <TabsList justify={"start"} className={"px-8"}>
              <TabsTrigger value={"resources"} data-testid="network-tab-resources">
                <Layers3Icon size={14} />
                {network?.resources?.length === 1 ? `1 ${t("networkDetails.resourceTab")}` : `${network?.resources?.length ?? 0} ${t("networkDetails.resourcesTab")}`}
              </TabsTrigger>
              <TabsTrigger
                value={"routing-peers"}
              ...
              >
                ...
                />
                {network?.routing_peers_count === 1 ? `1 ${t("networkDetails.routingPeerTab")}` : `${network?.routing_peers_count ?? 0} ${t("networkDetails.routingPeersTab")}`}
              </TabsTrigger>
              <TabsTrigger value={"services"} data-testid="network-tab-services">
                ...
                />
                {services.length === 1 ? `1 ${t("networkDetails.serviceTab")}` : `${services.length} ${t("networkDetails.servicesTab")}`}
              </TabsTrigger>
            </TabsList>
          ...
          value={
            ...
            >
              ...
              >
                ...
                ></span>
                {isHighlyAvailable ? t("networkDetails.active") : t("networkDetails.inactive")}
                <HelpCircle size={12} />
              </div>
            </FullTooltip>
          }
          ...
          value={
            policyCount > 0 ? (
              <InlineLink href={"/access-control"}>
                {t("networkDetails.goToPoliciesLink")}
